...
Most of these come down to network reality or how ena serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ena rate-limits like any public site. ena already paces
...
Where a surface is gated, ena reads a cookie or token you supply
...
`ena`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ena actually did
