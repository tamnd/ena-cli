...
func TestHostWiring(t *testing.T) {
	...
	if want := "ena://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ena", "about")
	if err != nil || got.String() != "ena://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ena://page/about", got.String(), err)
	}
}
